...
"")
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 691, 151))
        ...
        self.labTTemp1 = QtWidgets.QLabel(self.groupBox)
        self.labTTemp1.setObjectName("labTTemp1")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.labTTemp1)
        self.label_10 = QtWidgets.QLabel(self.groupBox)
        self.label_10.setObjectName("label_10")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_10)
        self.labTTemp2 = QtWidgets.QLabel(self.groupBox)
        self.labTTemp2.setObjectName("labTTemp2")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.labTTemp2)
        ...
        self.labTTemp1Avg = QtWidgets.QLabel(self.groupBox)
        self.labTTemp1Avg.setObjectName("labTTemp1Avg")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.labTTemp1Avg)
        self.label_2 = QtWidgets.QLabel(self.groupBox)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_2)
        self.labTTemp2Avg = QtWidgets.QLabel(self.groupBox)
        self.labTTemp2Avg.setObjectName("labTTemp2Avg")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.labTTemp2Avg)
        ...
        self.labTTemp1Max = QtWidgets.QLabel(self.groupBox)
        self.labTTemp1Max.setObjectName("labTTemp1Max")
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.labTTemp1Max)
        self.label_21 = QtWidgets.QLabel(self.groupBox)
        self.label_21.setObjectName("label_21")
        self.formLayout_6.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_21)
        self.labTTemp2Max = QtWidgets.QLabel(self.groupBox)
        self.labTTemp2Max.setObjectName("labTTemp2Max")
        self.formLayout_6.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.labTTemp2Max)
        ...
        self.labTTemp1Min = QtWidgets.QLabel(self.groupBox)
        self.labTTemp1Min.setObjectName("labTTemp1Min")
        self.formLayout_8.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.labTTemp1Min)
        ...
        self.labTTemp2Min = QtWidgets.QLabel(self.groupBox)
        self.labTTemp2Min.setObjectName("labTTemp2Min")
        self.formLayout_8.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.labTTemp2Min)
        self.horizontalLayout_3.addLayout(self.formLayout_8)
        self.groupBox_2 = QtWidgets.QGroupBox(self.pageDiag)
        self.groupBox_2.setGeometry(QtCore.QRect(10, 200, 691, 91))
        ...
        self.labTCpu = QtWidgets.QLabel(self.groupBox_2)
        self.labTCpu.setObjectName("labTCpu")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.labTCpu)
        ...
        self.labTCpuAvg = QtWidgets.QLabel(self.groupBox_2)
        self.labTCpuAvg.setObjectName("labTCpuAvg")
        self.formLayout_5.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.labTCpuAvg)
        ...
        self.labTCpuMax = QtWidgets.QLabel(self.groupBox_2)
        self.labTCpuMax.setObjectName("labTCpuMax")
        self.formLayout_7.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.labTCpuMax)
        ...
        self.labTCpuMin = QtWidgets.QLabel(self.groupBox_2)
        self.labTCpuMin.setObjectName("labTCpuMin")
        self.formLayout_9.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.labTCpuMin)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labTTemp1.setText(_translate("MainWindow", "0 *C"))
        self.label_10.setText(_translate("MainWindow", "Temperatura 2:"))
        self.labTTemp2.setText(_translate("MainWindow", "0 *C"))
        ...
        self.labTTemp1Avg.setText(_translate("MainWindow", "0 *C"))
        self.label_2.setText(_translate("MainWindow", "Średnia:"))
        self.labTTemp2Avg.setText(_translate("MainWindow", "0 *C"))
        self.label_18.setText(_translate("MainWindow", "Maks.:"))
        self.labTTemp1Max.setText(_translate("MainWindow", "0 *C"))
        self.label_21.setText(_translate("MainWindow", "Maks.:"))
        self.labTTemp2Max.setText(_translate("MainWindow", "0 *C"))
        self.label_25.setText(_translate("MainWindow", "Min.:"))
        self.labTTemp1Min.setText(_translate("MainWindow", "0 *C"))
        self.label_27.setText(_translate("MainWindow", "Min.:"))
        self.labTTemp2Min.setText(_translate("MainWindow", "0 *C"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Procesor"))
        self.label_13.setText(_translate("MainWindow", "Temperatura: "))
        self.labTCpu.setText(_translate("MainWindow", "0 *C"))
        self.label_17.setText(_translate("MainWindow", "Średnia:"))
        self.labTCpuAvg.setText(_translate("MainWindow", "0 *C"))
        self.label_23.setText(_translate("MainWindow", "Maks.:"))
        self.labTCpuMax.setText(_translate("MainWindow", "0 *C"))
        self.label_29.setText(_translate("MainWindow", "Min.:"))
        self.labTCpuMin.setText(_translate("MainWindow", "0 *C"))
